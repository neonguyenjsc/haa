                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <form action="{{getUri()}}/buy" method="post" id="form_order">
                                        ...
                                        {{--                                            <label class="fw-bold form-label">Nhập ghi chú</label>--}}
                                        {{--                                            <input name="cookie" onchange="checkCookie()" id="object_id" type="text"--}}
                                        ...
                                        <div class="form-group mt-3">
                                            <label class="fw-bold form-label">Tên ghi nhớ:</label>
                                            <input name="notes" class="form-control rounded-10"
                                                   value=""
                                                   type="text" min="100" placeholder="Tên ghi nhớ" required>
                                        </div>
                                        ...
                                        <div class="form-group mt-3">
                                            <label class="fw-bold form-label">Proxy quốc gia:</label>
                                        ...
                                        <div class="form-group mt-3">
                                            <label class="fw-bold form-label">Số ngày mua:</label>
                                            <select name="quantity" onchange="checkOutCoin()" class="form-control">
