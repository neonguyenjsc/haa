...
@section('content')
                                ...
                                <div class="col-md-8">
                                    <form action="{{getUri()}}/buy" method="post" id="form_order">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="object_id" id="object_id" type="text" onchange="convertUid()"
                                        ...
                                        <div class="form-group mt-3" style="display: none" id="review_group">
                                            <label for="inputAddress2" class="form-label fw-bold">Nội dung
                                                review: </label>
                                            ...
                                            <textarea class="form-control rszn rounded-10" id="inputAddress2"
                                                      name="review"
                                                      placeholder="Nội dung review. 1 dòng = 1 review"
                                                      rows="3"></textarea>
                                        </div>
    ...
    <script>
        ...
        function checkOutCoin() {
            ...
            if (package_name === 'facebook_rating_page_sv1' || package_name === 'facebook_rating_page_sv2' || package_name === 'facebook_checkin_page_sv3' || package_name === 'facebook_checkin_page_sv4') {
                $('#review_group').css('display', 'block');
            } else {
                $('#review_group').css('display', 'none');
            }
