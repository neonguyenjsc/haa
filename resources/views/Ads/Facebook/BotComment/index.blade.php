                                                    ...
                                                    @foreach($package as $i=>$item)
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label"
                                                                ...
                                                                <span
                                                                    class="text-danger">{{number_format($item->prices)}} {{getCurrency()}}</span>
                                                                @if($item->status == 1)
                                                                    @if($item->sl)
                                                                        <span
                                                                            class="badge bg-custom-3">{{$item->sl}}</span></label>
                                                            @endif
                                                            <span class="badge bg-custom-9">Hoạt động</span></label>
                                                            @else

                                                                <span class="badge bg-custom-4">Bảo trì</span></label>
                                                            @endif
                                                        </div>
                                                    @endforeach
                                                </div>
