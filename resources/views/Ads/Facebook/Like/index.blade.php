                                ...
                                <div class="col-md-8">
                                    <form action="{{getUri()}}/buy" method="post" id="form_order">
                                        ...
                                        <div class="alert alert-info rounded-10 shadow-lg border-0 mt-3">
                                            ...
                                            <a class="fw-bold" target="_blank"
                                               href="https://www.youtube.com/watch?v=n1Pv2Xel6Wo">[ Video hướng dẫn ]</a>
                                        </div>
                                        <div class="form-group">
                                            <label class="font-weight-bold">Loại cảm xúc :</label>
                                            <div class="text-left mt-3">
                                                @if(isset($package))
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label "
                                                                ...
                                                                <input class="form-check-input checkbox d-none"
                                                                       type="radio" id="inlineRadio{{$i}}"
                                                                       name="package_name"
                                                                       data-price="{{$item->prices}}"
                                                                       onchange="checkOutCoin()"
                                                                       {{($i == 0) ?'checked' : ''}}
                                                                       value="{{$item->package_name}}">
                                                                <img
                                                                    src="/assets/images/fb-reaction/{{$item->package_name}}.png"
                                                                    alt="{{str_replace("seeding_by_workers_","",$item->package_name)}}"
                                                    ...
                                                    @endforeach
                                                @else
                                                    <h3>Không thể cập nhật cảm xúc. Vui lòng đăng nhập
                                                        lại</h3>
                                                @endif
                                            </div>
                                        </div>
