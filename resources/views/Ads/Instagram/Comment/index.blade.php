...
@section('content')
                                ...
                                <div class="col-md-8">
                                    <form action="{{getUri()}}/buy" method="post" id="form_order">
                                        ...
                                        <div class="form-group">
                                            <label class="fw-bold form-label">Nhập Link:</label>
                                        ...
                                        <div class="form-group mt-3">
                                            <label for="inputAddress2" class="form-label fw-bold">Nội dung bình luận: </label>
                                            <span class="badge bg-custom-7 mb-2 text-white py-2 ">Số lượng: <span
                                                    class="badge bg-custom-8" style="color: black" id="quantity_cmt">0</span></span>
                                            <textarea class="form-control rszn rounded-10" id="inputAddress2" name="list_message"
                                                      placeholder="Nội dung bình luận. 1 dòng = 1 bình luận" rows="3"></textarea>
                                        </div>
    ...
    <script>
        ...
        function checkOutCoin() {
            ...
            addTextId('txt_quantity', formatNumber(count));
