            ...
            <div class="card">
                <div class="card-body">
                    <div class="tab-content py-3">
                        <h4>Thêm mã giao dịch vcb</h4>
                        <div class="tab-pane fade show active">
                            <div class="box-header with-border pb-2">
                                @include('Libs.success_message')
                            </div>
                            <h6><a href="/admin/auto-payment/vcb"><span
                                        class="badge bg-warning">Quay lại</span></a></h6>
                            <form action="/admin/auto-payment/vcb/add" method="POST" id="order_form">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1"
                                               aria-describedby="emailHelp" name="id" placeholder="ví dụ : xxxx - xxxx">
                                    </div>
                                    <div class="form-group">
