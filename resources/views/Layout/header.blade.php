<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            <div style="display: none" class="top-menu ms-auto">
                            ...
                            <div class="header-notifications-list">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="msg-name">
                                                Your item is shipped <span class="msg-time float-end">5 hrs ago</span>
                                            </h6>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                   role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{getInfoUser('avatar') ?? '/assets/images/avatars/avatar-2.png'}}" class="user-img"
                         alt="user avatar"/>
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{getInfoUser('name')}}</p>
                        <p class="designattion mb-0">{{getInfoUser('level')}}</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" href="/tai-khoan"><i class="bx bx-user"></i><span>Tài
                                khoản</span></a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="/nap-tien"><i class="bx bx-dollar-circle"></i><span>Nạp
                                tiền</span></a>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                        <a class="dropdown-item" href="/logout"><i class="bx bx-log-out-circle"></i><span>Đăng
                                xuất</span></a>
                    </li>
                </ul>
            </div>
