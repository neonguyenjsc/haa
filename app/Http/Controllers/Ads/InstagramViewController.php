...
class InstagramViewController extends Controller
{
    //

    protected $menu_id = 74;
    ...
    public function index()
    {
        ...
        return view('Ads.Instagram.View.index', ['menu' => $menu, 'package' => $package]);
    }
    ...
    public function history(Request $request)
    {
        ...
        return view('Ads.Instagram.View.history', ['data' => $data, 'menu' => $menu]);
    }
