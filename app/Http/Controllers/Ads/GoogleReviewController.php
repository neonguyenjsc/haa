...
class GoogleReviewController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Ads.Instagram.Comment.index', ['menu' => $menu, 'package' => $package]);
    }
    ...
    public function history(Request $request)
    {
        ...
        return view('Ads.Instagram.Comment.history', ['data' => $data, 'menu' => $menu]);
    }
...
//            'quantity' => 'integer|min:1',
            ...
            'object_id' => 'required|string|max:500'
        ], [
...
//                                $post_data = $request->except('client_id','client_username');
            ...
            return returnDataError(['error_' => 'lỗi']);
        }
        return returnDataError($pricesData);
    }

    public function callApiGTC($data)
    {
        $data['username'] = 'baostar9999';
        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://gachthecao.net/api/instagram/comment/add',
