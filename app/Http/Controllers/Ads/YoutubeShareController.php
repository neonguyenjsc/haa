...
class YoutubeShareController extends Controller
{
    protected $menu_id = 96;
    ...
    public function index()
    {
        ...
        return view('Ads.Youtube.Share.index', ['menu' => $menu, 'package' => $package]);
    }
    ...
    public function history(Request $request)
    {
        ...
        return view('Ads.Youtube.Share.history', ['data' => $data, 'menu' => $menu]);
    }
