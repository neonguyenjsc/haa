...
class YoutubeLiveStreamController extends Controller
{
    //
    protected $menu_id = 95;
    ...
    public function index()
    {
        ...
        return view('Ads.Youtube.LiveStream.index', ['menu' => $menu, 'package' => $package]);
    }
    ...
    public function history(Request $request)
    {
        ...
        return view('Ads.Youtube.LiveStream.history', ['data' => $data, 'menu' => $menu]);
    }
    ...
    public function actionBuy($request, $user)
    {
        ...
        if (!isset($pricesData['error'])) {
            ...
            if (!isset($checkMinMax['error'])) {
                switch ($package_name) {
                    case 'youtube_like_usa':
                    case 'youtube_like_real_max':
                    case 'youtube_like_real_top':
                    case 'youtube_like_fast_s2':
                    case 'youtube_like_it_tut':
