...
class InstagramViewStoryController extends Controller
{
    //
    protected $menu_id = 76;
    ...
    public function index()
    {
        ...
        return view('Ads.Instagram.ViewStory.index', ['menu' => $menu, 'package' => $package]);
    }
    ...
    public function history(Request $request)
    {
        ...
        return view('Ads.Instagram.ViewStory.history', ['data' => $data, 'menu' => $menu]);
    }
