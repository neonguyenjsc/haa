...
class YoutubeCommentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Ads.Youtube.Comment.index', ['menu' => $menu, 'package' => $package]);
    }
    ...
    public function history(Request $request)
    {
        ...
        return view('Ads.Youtube.Comment.history', ['data' => $data, 'menu' => $menu]);
    }
    ...
    public function actionBuy($request, $user)
    {
        ...
        if (!isset($pricesData['error'])) {
            ...
            if (!isset($checkMinMax['error'])) {
                switch ($package_name) {
                    case 'youtube_comment_2':
                    case 'youtube_comment_3':
                    ...
                    case 'youtube_comment_4':
                        ...
                        $checkCoinAndHandleCoin = $this->coinSerivce->checkCoinAndHandleCoin($user->id, $check_out_coin);
                        if (!isset($checkCoinAndHandleCoin['error'])) {
                            $url = DOMAIN_TRAODOISUB . '/mua/youtube_comment/themid.php';
